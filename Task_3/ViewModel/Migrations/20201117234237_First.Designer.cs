...
namespace ViewModel.Migrations
{
    ...
    [Migration("20201117234237_First")]
    partial class First
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ViewModel.ImageClass", b =>
                {
            ...
            modelBuilder.Entity("ViewModel.ImageFile", b =>
                {
            ...
            modelBuilder.Entity("ViewModel.ImageInfo", b =>
                {
            ...
            modelBuilder.Entity("ImageClassImageInfo", b =>
                {
                    b.HasOne("ViewModel.ImageClass", null)
                        .WithMany()
                        .HasForeignKey("ImageClassesImageClassId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ViewModel.ImageInfo", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ViewModel.ImageInfo", b =>
                {
                    b.HasOne("ViewModel.ImageFile", "ByteImage")
                        .WithMany()
